...
class TestLocation(unittest.TestCase):
    ...
    def test_constructor(self):
        location = Location('Dublin', 0, "culture1", 30, 25)
    ...
    def test_geo_distance(self):
        location1 = Location('Dublin', 0, "Irish", 30, 25)
        location2 = Location('Florida', 11, "American", 30, 25)

        self.assertTrue(location1.geo_distance(location2) == 3)

        location3 = Location('Canberra', 1, "Australian", 30, 25)
        location4 = Location('Toronto', 9, "Canadian", 30, 25)

        self.assertTrue(location3.geo_distance(location4) == 4)

        location5 = Location('Rio de Janeiro', 4, "Brazilian", 30, 25)
        location6 = Location('New Dehli', 9, "Indian", 30, 25)

        self.assertTrue(location5.geo_distance(location6) == 4)

        location7 = Location('New Dehli', 2, "Indian", 30, 25)
        location8 = Location('Tokyo', 5, "Japanese", 30, 25)
