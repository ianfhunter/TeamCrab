...
class TestLocation(unittest.TestCase):
    ...
    def test_temp_distance(self):
        ...
        self.assertTrue(location1.temp_distance(location2) == 2.0)
        ...
        self.assertTrue(location5.temp_distance(location6) == 3.0)

        location7 = Location('New Dehli', "Indian", 30)
        location8 = Location('Tokyo', "Japanese", 30)

        self.assertTrue(location7.temp_distance(location8) == 2.0)
