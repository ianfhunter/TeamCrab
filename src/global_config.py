...
config = {
        ...
        "cash_penalty" : 1.25,
        # Real-life seconds per game hour - Recommended minimum is 0.2 as issues with thread synchronization may occur below this level
        "game_speed" : 0.5,
        # How much a workers out put can vary by per hour +/-
        "hourly variation" : 25,
